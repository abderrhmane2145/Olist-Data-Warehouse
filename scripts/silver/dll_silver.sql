...
CREATE TABLE silver.olist_customers (
	customer_id              NVARCHAR(35),
	customer_zip_code_prefix INT,
	customer_city            NVARCHAR(35),
	customer_state           NVARCHAR(35),
...
CREATE TABLE silver.olist_geolocation (
	...
	geolocation_city            NVARCHAR(35),
	geolocation_state           NVARCHAR(35),
	dwh_create_date DATETIME2 DEFAULT GETDATE()
);
...
CREATE TABLE silver.olist_order_reviews (
	...
	order_id               NVARCHAR(35),
	review_score           INT ,
	review_comment_title   NVARCHAR(70),
...
CREATE TABLE silver.olist_sellers (
	...
	seller_city NVARCHAR(35),
	seller_state NVARCHAR(35),
	dwh_create_date DATETIME2 DEFAULT GETDATE()
);
